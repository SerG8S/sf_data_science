...
Зато при зависимости средней предполагаемой зп от кредитного рейтинга видны закономерности, связанные с ушедшими клиентами, которые имеют больший разброс. Также лояльные клиенты с рейтингом от 500 до 800 имеют предполагаемую среднюю зп от 75т.$ до 125т.$.
### 4.6. Задание
