...
5. Выполнил предобработку данных:
   ...
   8. Делаем сводную таблицу стран в которых есть ушедшие клиенты (countryes (Задание 9.9)).
   9. Создаем функция для преобразования числового признака в категориальный (get_credit_score_cat).
...
![Иллюстрация к проекту](https://github.com/SerG8S/sf_data_science/blob/main/project_visualisation/salary_mean.png)
- Выводы:
