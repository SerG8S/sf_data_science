...
2. Загрузил дата фрейм:'churn.csv'.
4. Изучил доступные средства визуализации в среде разработки Jupyter Notebook.
5. Согласно правилам визуализации выполнил задание по обработке данных, а также списку вопросов от банка:
![Иллюстрация к проекту](https://github.com/SerG8S/sf_data_science/blob/main/diagrams.jpeg)
