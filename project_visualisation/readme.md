...
3. Удалил незадействованные столбцы:
...
![Иллюстрация к проекту](https://github.com/SerG8S/sf_data_science/blob/main/project_visualisation/age_distributiont_0.png)
- Вывод:
...
- Выводы:
Исходя из построенных графиков какой-либо зависимости между кредитным рейтингом и предполагаемой зп не просматривается. Можно заметить, что только у ушедших клиентов есть рейтинг ниже 400.
Зато при зависимости средней предполагаемой зп от кредитного рейтинга видны закономерности, связанные с ушедшими клиентами, которые имеют больший разброс. Также лояльные клиенты с рейтингом от 500 до 800 имеют предполагаемую среднюю зп от 75 тысяч USD до 125 тысячи USD.
### 4.6. Задание
...
Написана программа [project_visualisation.ipynb](https://github.com/SerG8S/sf_data_science/blob/main/project_visualisation/project_visualisation.ipynb) для визуализации базы данных об оттоке клиентов банка и получено представление о собранных и обработанных данных.

## Выводы

В процессе написания программы приобретены навыки работы с необходимыми средствами обработки и визуализации для профессии [Учённый по данным](https://skillfactory.ru/data-science-specialization).
