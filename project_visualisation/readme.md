...
5. Выполнил предобработку данных:
   ...
   3. Делаем сводную таблицу (bar_data).
   4. Фильтруем по полу (gender).
   5. Делаем сводную таблицу (activ).
   6. Делаем сводную таблицу (churn_countryes).
...
- Количество лояльных практически в 4 раза больше, чем ушедших. Позитивный показатель, который говорит об отсутсвии массового оттока клиентов, не более 20%.
