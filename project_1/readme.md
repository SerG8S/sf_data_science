...
- Мода распределения призанка возраста находится левее среднего значения, значит это положительная ассиметрия.
...
В процессе написания программы приобретены навыки работы с необходимыми инструментами для Data Science.
