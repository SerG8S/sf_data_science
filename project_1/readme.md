...
- Из коробачтой диагармы видно, за пределами правого "уса" довольно много значений, но их плотность уменьшается начиная со значения 510(42.5 года). Значения правее опыта от 586(49) до 1188(99) я бы отнес к аномальным.
...
- Предельные значения признака находятся в пределах от 0 рублей до 24 миллионов рублей.
...
- Из полученного распределения видно, что медианная зарплата у соискателей с высшим образованием выше всего, соискатели со средним и средним специальным образование запрашивают одинаково и меньше всего. Поэтому чем выше степень образования, тем выше запрашиваемая зарплата.
- Принято решение провести дополнительное исследование с построением графика, где, будет распределение по половому признаку.
